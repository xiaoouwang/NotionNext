...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xo_nlp', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A random person in the chaotic world🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'xiaoouwang.org', // 网站地址
